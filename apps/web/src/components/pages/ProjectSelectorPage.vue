...
function openDeleteConfirm(project) {
    deleteConfirm.value = { slug: project.slug, displayName: project.latestVersion?.displayName ?? project.slug };
                    ...
                    <div class="flex items-start justify-between gap-2">
                        <div class="min-w-0">
                            <div class="font-title font-semibold text-sm group-hover:text-orange-darker transition-colors truncate">
                                {{ project.latestVersion?.displayName ?? project.slug }}
                            </div>
